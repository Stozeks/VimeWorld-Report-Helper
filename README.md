...
**VimeWorld Report Helper — локальная система поддержки модерации, которая анализирует сообщения репорта, восстанавливает искажённые формы, использует несколько независимых источников знаний, учитывает контекст, обучается на подтверждённых модератором случаях, классифицирует найденные нарушения и визуально рекомендует подходящую причину, оставляя окончательное решение человеку.
...
Постепенно проект вырос намного сильнее, чем планировалось. Сейчас VRH не только дополняет интерфейс страницы, но и помогает разбирать сообщения из репорта, искать возможные нарушения, распознавать искажённые написания, учитывать связь между сообщениями, подсказывать подходящую категорию и постепенно накапливать подтверждённые модератором знания.

При этом основной принцип проекта не изменился: **VRH помогает модератору, но не принимает решение вместо него.**

<p align="center">
  <img src="docs/images/vrh-reports-page.png" alt="VimeWorld Reports с установленным VRH" width="100%">
</p>
