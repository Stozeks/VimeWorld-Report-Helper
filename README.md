...
Благодаря этому не нужно отдельно искать среди всех причин, к какой категории относится найденный фрагмент — сканер сразу показывает предполагаемую категорию нарушения.
...
<p align="center">
  <sub>Вместе с найденной фразой VRH подсвечивает плитку категории, к которой сканер отнёс нарушение.</sub>
</p>
...
Если нарушение определяется именно через связь между сообщениями, соответствующая плитка причины также может быть отмечена в панели. Для таких срабатываний используется отдельная метка `REL`, чтобы их можно было отличить от обычного словарного совпадения.
...
Это позволяет быстро увидеть не только **что именно** нашёл сканер, но и **почему он считает это нарушением**.
